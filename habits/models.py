...
class Habit(models.Model):
    ...
    pleasant_habit = models.ForeignKey("self", on_delete=models.CASCADE, related_name='pleasant', verbose_name='Приятная привычка', **NULLABLE)
    tied_habit = models.ForeignKey("self", on_delete=models.CASCADE, verbose_name='Связанная привычка', **NULLABLE)
